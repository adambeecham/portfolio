...
/***/ "./src/js/components/_splitText.js":
/*!*****************************************!*\
  !*** ./src/js/components/_splitText.js ***!
  \*****************************************/
...
/* harmony export */   "default": () => (/* binding */ initSplitText)
/* harmony export */ });
/* harmony import */ var _libraries_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../libraries/SplitText.min.js */ "./src/js/libraries/SplitText.min.js");
/* harmony import */ var _libraries_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_libraries_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0__);

function initSplitText() {
  var wordsToSplit = document.querySelectorAll('[data-split-words]'),
      charsToSplit = document.querySelectorAll('[data-split-chars]'),
      linesToSplit = document.querySelectorAll('[data-split-lines]');
  document.fonts.ready.then(function () {
    var wordSplit = new (_libraries_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0___default())(wordsToSplit, {
      type: 'words',
      wordsClass: 'word'
    }),
        lineSplit = new (_libraries_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0___default())(linesToSplit, {
      type: 'lines',
      linesClass: 'line'
    }),
        charSplit = new (_libraries_SplitText_min_js__WEBPACK_IMPORTED_MODULE_0___default())(charsToSplit, {
      type: 'chars',
      charsClass: 'char'
    });
    wordSplit.words.forEach(function (el) {
...
/* harmony import */ var _locomotiveScroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./locomotiveScroll.js */ "./src/js/components/locomotiveScroll.js");
...
var initBarba = function initBarba() {
  _barba_core__WEBPACK_IMPORTED_MODULE_0___default().init({
    ...
    prevent: function prevent(_ref) {
      var el = _ref.el;
      return el.classList.contains('ab-item');
    },
    transitions: [{
  ...
  _barba_core__WEBPACK_IMPORTED_MODULE_0___default().hooks.after(function (data) {});
};
...
/***/ "./src/js/components/helloWorld.js":
/*!*****************************************!*\
  !*** ./src/js/components/helloWorld.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "snapToTop": () => (/* binding */ snapToTop),
/* harmony export */   "default": () => (/* binding */ scrollUpdate)
/* harmony export */ });
...
var navigation = function navigation() {
  var buttons = document.querySelectorAll('.toggle-navigation');
...
var req = __webpack_require__("./src/js/components sync recursive \\.(js)$/");
...
var map = {
	"./_splitText.js": "./src/js/components/_splitText.js",
	"./barba.js": "./src/js/components/barba.js",
	"./helloWorld.js": "./src/js/components/helloWorld.js",
	"./locomotiveScroll.js": "./src/js/components/locomotiveScroll.js",
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkbegin_2022"] = self["webpackChunkbegin_2022"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["main","admin"], () => (__webpack_require__("./src/js/main.js")))
/******/ 	__webpack_require__.O(undefined, ["main","admin"], () => (__webpack_require__("./src/scss/main.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["main","admin"], () => (__webpack_require__("./src/scss/admin.scss")))
